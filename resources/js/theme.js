...
const theme = {
    ...
    textColor: {
        ...
        'table-row-muted-hover': withOpacity('--table-row-muted-hover'),
        'table-row-brand': withOpacity('--table-row-brand'),
        'table-row-brand-hover': withOpacity('--table-row-brand-hover'),
        'table-row-danger': withOpacity('--table-row-danger'),
        'table-row-danger-hover': withOpacity('--table-row-danger-hover'),
        'table-row-info': withOpacity('--table-row-info'),
        'table-row-info-hover': withOpacity('--table-row-info-hover'),
        'table-row-success': withOpacity('--table-row-success'),
        'table-row-success-hover': withOpacity('--table-row-success-hover'),
        'table-row-warning': withOpacity('--table-row-warning'),
        'table-row-warning-hover': withOpacity('--table-row-warning-hover'),
