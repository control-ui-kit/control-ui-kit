const theme = {
    backgroundColor: {
        ...
        'table-row-muted-hover': 'rgb(var(--table-row-muted-bg), <alpha-value>)',
        'table-row-brand': 'rgb(var(--table-row-brand-bg), <alpha-value>)',
        'table-row-brand-hover': 'rgb(var(--table-row-brand-hover-bg), <alpha-value>)',
        'table-row-danger': 'rgb(var(--table-row-danger-bg), <alpha-value>)',
        'table-row-danger-hover': 'rgb(var(--table-row-danger-hover-bg), <alpha-value>)',
        'table-row-info': 'rgb(var(--table-row-info-bg), <alpha-value>)',
        'table-row-info-hover': 'rgb(var(--table-row-info-hover-bg), <alpha-value>)',
        'table-row-success': 'rgb(var(--table-row-success-bg), <alpha-value>)',
        'table-row-success-hover': 'rgb(var(--table-row-success-hover-bg), <alpha-value>)',
        'table-row-warning': 'rgb(var(--table-row-warning-bg), <alpha-value>)',
        'table-row-warning-hover': 'rgb(var(--table-row-warning-hover-bg), <alpha-value>)',
    ...
    textColor: {
        ...
        'table-row-brand': 'rgb(var(--table-row-brand), <alpha-value>)',
        'table-row-danger': 'rgb(var(--table-row-danger), <alpha-value>)',
        'table-row-info': 'rgb(var(--table-row-info), <alpha-value>)',
        'table-row-success': 'rgb(var(--table-row-success), <alpha-value>)',
        'table-row-warning': 'rgb(var(--table-row-warning), <alpha-value>)',
