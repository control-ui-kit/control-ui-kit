...
>
    ...
    @else
        <button {{ $attributes->except('class') }} class="flex item-center space-x-1 text-table-header leading-4 font-medium uppercase tracking-wider group focus:outline-none focus:underline">
            <span>{{ $slot }}</span>
