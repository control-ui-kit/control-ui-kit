...
class PercentFieldTest extends ComponentTestCase
{
    public function setUp(): void
    {
        ...
        Config::set('themes.default.input-percent.decimals', 2);
        ...
        Config::set('themes.default.input-percent.suffix-text', '');
        Config::set('themes.default.input-percent.icon-right', '');
    ...
    public function the_field_decimal_component_can_be_rendered(): void
    {
        ...
        $template = <<<'HTML'
            <x-field-percent name="value" label="Value" />
            HTML;
