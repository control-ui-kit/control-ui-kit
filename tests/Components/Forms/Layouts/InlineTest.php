...
class InlineTest extends ComponentTestCase
{
    ...
    #[Test]
    public function the_inline_layout_component_can_be_rendered_with_underneath_text(): void
    {
        $this->withViewErrors(['test' => 'This is a test message']);

        $template = <<<'HTML'
            <x-form-layout-inline name="test" label="::Label" help="::Help" underneath="::Underneath" input="input-text" onblur="test()" />
            HTML;
