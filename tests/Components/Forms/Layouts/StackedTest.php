...
class StackedTest extends ComponentTestCase
{
    ...
    public function the_stacked_layout_component_can_be_rendered(): void
    {
        ...
        $template = <<<'HTML'
            <x-form-layout-stacked name="test" label="::Label" help="::Help" required>::SLOT</x-form-layout-stacked>
            HTML;
    ...
    public function the_stacked_layout_component_can_be_rendered_with_no_styles(): void
    {
        ...
        $template = <<<'HTML'
            <x-form-layout-stacked name="test" label="::Label" help="::Help" required
    ...
    public function the_stacked_layout_component_can_be_rendered_with_slot_and_custom_class(): void
    {
        ...
        $template = <<<'HTML'
            <x-form-layout-stacked name="test" label="::Label" help="::Help" class="float-right">::SLOT</x-form-layout-stacked>
            HTML;
    ...
    public function the_stacked_layout_component_can_be_rendered_with_input_and_custom_attribute(): void
    {
        ...
        $template = <<<'HTML'
            <x-form-layout-stacked name="test" label="::Label" help="::Help" input="input-text" onblur="test()" />
            HTML;
