...
class TimeTest extends ComponentTestCase
{
    ...
    {
        $template = <<<'HTML'
            <x-input-time name="time" show-am-pm value="09:46" />
            HTML;
    ...
    {
        $template = <<<'HTML'
            <x-input-time name="time" show-am-pm value="21:46" />
            HTML;
    ...
    {
        $template = <<<'HTML'
            <x-input-time name="time" hours="0,6,12,18" minutes="0,20,40" />
            HTML;
    ...
    {
        $template = <<<'HTML'
            <x-input-time name="time" format="g:i A" />
            HTML;
    ...
    {
        $template = <<<'HTML'
            <x-input-time name="time" format="H:i" />
            HTML;
    ...
    {
        $template = <<<'HTML'
            <x-input-time name="time" format="H:i:s" />
            HTML;
    ...
    {
        $template = <<<'HTML'
            <x-input-time name="time" show-seconds />
            HTML;
    ...
    {
        $template = <<<'HTML'
            <x-input-time name="time" show-seconds seconds="0,10,20,30,40,50" />
            HTML;
