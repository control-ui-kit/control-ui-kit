...
class CurrencyTest extends ComponentTestCase
{
    ...
    public function an_input_currency_component_can_be_rendered(): void
    {
        ...
        $expected = <<<'HTML'
            <div x-data="Components.inputNumber({ id: 'name', value: null, decimals: 2, min: 0, })" x-modelable="value" class="wrapper-width">
                <input type="number" id="name_display" x-model.lazy="display" min="0" step="0.01" class="background border color currency-font other padding rounded shadow width" />
    ...
    #[Test]
    public function an_input_currency_component_can_be_rendered_with_currency_symbol(): void
    {
        Config::set('themes.default.input-currency.prefix-text', '£');
        ...
        $expected = <<<'HTML'
            <div x-data="Components.inputNumber({ id: 'name', value: null, decimals: 2, min: 0, })" x-modelable="value" class="wrapper-background wrapper-border wrapper-color wrapper-font wrapper-other wrapper-padding wrapper-rounded wrapper-shadow wrapper-width">
                ...
                <input type="number" id="name_display" x-model.lazy="display" min="0" step="0.01" class="input-background input-border input-color currency-input-font input-other input-padding input-rounded input-shadow" />
                <input name="name" type="hidden" id="name" x-model="value" />
            </div>
            HTML;
    ...
    #[Test]
    public function an_input_currency_component_can_be_rendered_with_inline_currency_symbol(): void
    {
        Config::set('themes.default.input-currency.prefix-text', '£');

        $template = <<<'HTML'
            <x-input-currency name="name" symbol="$" />
            HTML;
    ...
    public function an_input_currency_component_with_placeholder_amended(): void
    {
        ...
        $expected = <<<'HTML'
            <div x-data="Components.inputNumber({ id: 'name', value: null, decimals: 2, min: 0, })" x-modelable="value" class="wrapper-width">
                <input type="number" id="name_display" x-model.lazy="display" placeholder="placeholder text" min="0" step="0.01" class="background border color currency-font other padding rounded shadow width" />
                <input name="name" type="hidden" id="name" x-model="value" />
            </div>
            HTML;
    ...
    #[Test]
    public function an_input_currency_component_can_be_rendered_with_onblur(): void
    {
        $template = <<<'HTML'
        ...
        $expected = <<<'HTML'
            <div x-data="Components.inputNumber({ id: 'name', value: null, decimals: 2, min: 0, })" x-modelable="value" class="wrapper-width">
                <input type="number" id="name_display" x-model.lazy="display" min="0" step="0.01" class="background border color currency-font other padding rounded shadow width" onblur="::someBlur" />
                <input name="name" type="hidden" id="name" x-model="value" />
            </div>
            HTML;
    ...
    {
        Config::set('themes.default.input-currency.decimals', 1);
        Config::set('themes.default.input-currency.default', 0.00);
        ...
        $expected = <<<'HTML'
            <div x-data="Components.inputNumber({ id: 'name', value: 0, decimals: 1, min: 0, })" x-modelable="value" class="wrapper-width">
                <input type="number" id="name_display" x-model.lazy="display" min="0" step="0.1" class="background border color currency-font other padding rounded shadow width" />
                <input name="name" type="hidden" id="name" x-model="value" />
            </div>
            HTML;
    ...
    #[Test]
    public function an_input_currency_component_can_be_rendered_with_inline_decimals(): void
    {
        Config::set('themes.default.input-currency.decimals', 4);
        Config::set('themes.default.input-currency.default', 0.00);

        $template = <<<'HTML'
            <x-input-currency name="name" value="1.23456789" step="0.1" />
            HTML;
    ...
    public function an_input_currency_component_can_be_rendered_with_allow_negatives_enabled(): void
    {
        ...
        $template = <<<'HTML'
            <x-input-currency name="name" allow-negatives />
            HTML;

        $expected = <<<'HTML'
            <div x-data="Components.inputNumber({ id: 'name', value: null, decimals: 2, })" x-modelable="value" class="wrapper-width">
                <input type="number" id="name_display" x-model.lazy="display" step="0.01" class="background border color currency-font other padding rounded shadow width" />
                <input name="name" type="hidden" id="name" x-model="value" />
            </div>
            HTML;
    ...
    #[Test]
    public function an_input_currency_component_can_be_rendered_with_min_disabled(): void
    {
        Config::set('themes.default.input-currency.min', 10);
        Config::set('themes.default.input-currency.max', null);

        $template = <<<'HTML'
            <x-input-currency name="name" min="none" />
            HTML;
    ...
    #[Test]
    public function an_input_currency_component_can_be_rendered_with_max_disabled(): void
    {
        Config::set('themes.default.input-currency.min', null);
        Config::set('themes.default.input-currency.max', 10);

        $template = <<<'HTML'
            <x-input-currency name="name" max="none" />
            HTML;
    ...
    #[Test]
    public function an_input_currency_component_can_be_rendered_with_step_disabled(): void
    {
        Config::set('themes.default.input-currency.min', null);

        $template = <<<'HTML'
            <x-input-currency name="name" step="none" />
            HTML;

        $expected = <<<'HTML'
            <div x-data="Components.inputNumber({ id: 'name', value: null, decimals: 2, })" x-modelable="value" class="wrapper-width">
                <input type="number" id="name_display" x-model.lazy="display" class="background border color currency-font other padding rounded shadow width" />
                <input name="name" type="hidden" id="name" x-model="value" />
            </div>
            HTML;
    ...
    #[Test]
    public function an_input_currency_component_can_be_rendered_with_min_and_max_values(): void
    {
        $template = <<<'HTML'
            <x-input-currency name="name" min="1.4" max="8.9" />
            HTML;

        $expected = <<<'HTML'
            <div x-data="Components.inputNumber({ id: 'name', value: null, decimals: 2, max: 8.9, min: 1.4, })" x-modelable="value" class="wrapper-width">
                <input type="number" id="name_display" x-model.lazy="display" min="1.4" max="8.9" step="0.01" class="background border color currency-font other padding rounded shadow width" />
                <input name="name" type="hidden" id="name" x-model="value" />
            </div>
            HTML;
    ...
    #[Test]
    public function an_input_currency_component_can_be_rendered_with_custom_step(): void
    {
        $template = <<<'HTML'
            <x-input-currency name="name" step="0.1" />
            HTML;
    ...
    #[Test]
    public function an_input_currency_component_can_be_rendered_with_no_symbol_and_with_custom_attributes(): void
    {
        $template = <<<'HTML'
            <x-input-currency name="name" onblur="console.log(this)" />
            HTML;

        $expected = <<<'HTML'
            <div x-data="Components.inputNumber({ id: 'name', value: null, decimals: 2, min: 0, })" x-modelable="value" class="wrapper-width">
                <input type="number" id="name_display" x-model.lazy="display" min="0" step="0.01" class="background border color currency-font other padding rounded shadow width" onblur="console.log(this)" />
                <input name="name" type="hidden" id="name" x-model="value" />
            </div>
            HTML;
    ...
    #[Test]
    public function an_input_currency_component_can_be_rendered_with_symbol_and_with_custom_attributes(): void
    {
        $template = <<<'HTML'
            <x-input-currency name="name" symbol="£" onblur="console.log(this)" />
            HTML;

        $expected = <<<'HTML'
            <div x-data="Components.inputNumber({ id: 'name', value: null, decimals: 2, min: 0, })" x-modelable="value" class="wrapper-background wrapper-border wrapper-color wrapper-font wrapper-other wrapper-padding wrapper-rounded wrapper-shadow wrapper-width">
                <div class="prefix-background prefix-border prefix-color prefix-font prefix-other prefix-padding prefix-rounded prefix-shadow"> £ </div>
                <input type="number" id="name_display" x-model.lazy="display" min="0" step="0.01" class="input-background input-border input-color currency-input-font input-other input-padding input-rounded input-shadow" onblur="console.log(this)" />
                <input name="name" type="hidden" id="name" x-model="value" />
            </div>
            HTML;
    ...
    #[Test]
    public function an_input_currency_component_can_be_rendered_with_no_symbol_and_with_custom_class(): void
    {
        $template = <<<'HTML'
            <x-input-currency name="name" class="float-right" />
            HTML;
    ...
    #[Test]
    public function an_input_currency_component_can_be_rendered_with_symbol_and_with_custom_class(): void
    {
        $template = <<<'HTML'
            <x-input-currency name="name" symbol="£" class="float-right" />
            HTML;
