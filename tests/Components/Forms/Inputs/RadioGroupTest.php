...
class RadioGroupTest extends ComponentTestCase
{
    ...
    {
        $template = <<<'HTML'
            <x-input-radio name="name" value="value_field" class="float-right" />
            HTML;

        $expected = <<<'HTML'
            <input name="name" type="radio" id="name_value_field" value="value_field" class="background border color other padding rounded shadow float-right" />
            HTML;
    ...
    {
        $template = <<<'HTML'
            <x-input-radio name="name" value="value_field" onclick="alert('here')" />
            HTML;

        $expected = <<<'HTML'
            <input name="name" type="radio" id="name_value_field" value="value_field" class="background border color other padding rounded shadow" onclick="alert('here')" />
            HTML;
