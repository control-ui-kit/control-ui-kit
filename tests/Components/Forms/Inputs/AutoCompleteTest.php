...
class AutoCompleteTest extends ComponentTestCase
{
    ...
    public function an_autocomplete_component_can_be_rendered_with_inline_styles(): void
    {
        ...
        $expected = <<<'HTML'
            <div x-data='Components.inputAutocomplete({ value: "", filter: "", config: {"value":"id","text":"text","subtext":"subtext","image":"image","limit":999,"min":1}, ajax: [], preload: [], focusLoad: [], conditionals: {"option-focus":"63","option-selected":"68","subtext-focus":"83","subtext-selected":"88","text-focus":"93","text-selected":"98"}, data: [{"id":1,"text":"France","sub":null,"image":null},{"id":2,"text":"Germany","sub":null,"image":null}], focus: [] })' x-cloak x-modelable="value" class="1 2 3 4 5 6 7 8 9">
