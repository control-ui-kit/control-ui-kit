...
class AutoCompleteTest extends ComponentTestCase
{
    ...
    public function an_autocomplete_component_can_be_rendered_with_inline_styles(): void
    {
        ...
        $expected = <<<'HTML'
            <div x-data='Components.inputAutocomplete({ value: "", filter: "", config: {"value":"id","text":"text","subtext":"subtext","image":"image","limit":999,"min":1}, ajax: [], preload: [], focusLoad: [], conditionals: {"option-focus":"63","option-selected":"68","subtext-focus":"83","subtext-selected":"88","text-focus":"93","text-selected":"98"}, })' x-cloak x-modelable="value" x-init='init( [{"id":1,"text":"France","subtext":null,"image":null},{"id":2,"text":"Germany","subtext":null,"image":null}], [] )' class="1 2 3 4 5 6 7 8 9">
    ...
    public function an_autocomplete_component_can_be_rendered_with_no_styles(): void
    {
        ...
        $expected = <<<'HTML'
            <div x-data='Components.inputAutocomplete({ value: "", filter: "", config: {"value":"id","text":"text","subtext":"subtext","image":"image","limit":999,"min":1}, ajax: [], preload: [], focusLoad: [], conditionals: {"option-focus":"","option-selected":"","subtext-focus":"","subtext-selected":"","text-focus":"","text-selected":""}, })' x-cloak x-modelable="value" x-init='init( [{"id":1,"text":"France","subtext":null,"image":null},{"id":2,"text":"Germany","subtext":null,"image":null}], [] )' class="">
    ...
    public function an_autocomplete_component_can_be_rendered_with_multi_dimensional_array_data(): void
    {
        ...
        $expected = <<<'HTML'
            <div x-data='Components.inputAutocomplete({ value: "", filter: "", config: {"value":"id","text":"text","subtext":"subtext","image":"image","limit":999,"min":1}, ajax: [], preload: [], focusLoad: [], conditionals: {"option-focus":"option-focus","option-selected":"option-selected","subtext-focus":"subtext-focus","subtext-selected":"subtext-selected","text-focus":"text-focus","text-selected":"text-selected"}, })' x-cloak x-modelable="value" x-init='init( [{"id":16,"text":"English","subtext":"GB","image":"https:\/\/cdn.label-worx.com\/media\/flags\/GB.png"},{"id":34,"text":"German","subtext":"DE","image":"https:\/\/cdn.label-worx.com\/media\/flags\/DE.png"}], [] )' class="background border color font other padding rounded shadow width">
                <div class="wrapper-background wrapper-border wrapper-color wrapper-font wrapper-other wrapper-padding wrapper-rounded wrapper-shadow wrapper-width" @click.away="close()">
                    <input name="countries_search" type="text" id="countries_search" x-model="filter" @mousedown="open()" @focus="open()" @input.debounce.250="refreshOptions()" @keydown.escape="close()" @keydown.tab="close()" @keydown.enter.stop.prevent="selectOption()" @keydown.arrow-up.prevent="focusPrevOption()" @keydown.arrow-down.prevent="focusNextOption()" autocomplete="off" autocapitalize="off" class="input-background input-border input-color input-font input-other input-padding input-rounded input-shadow" />
                    <svg class="clear-size fill-current clear-background clear-border clear-color clear-other clear-padding clear-rounded clear-shadow" x-show="selected" @click="clear()" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path clip-rule="evenodd" d="M19.5669 5.29918L18.2677 4l-6.7008 6.7008L4.86608 4 3.56689 5.29918 10.2677 12l-6.70081 6.7008L4.86608 20l6.70082-6.7008L18.2677 20l1.2992-1.2992L12.8661 12l6.7008-6.70082z"/>
    ...
    public function an_autocomplete_component_can_be_rendered_with_custom_class(): void
    {
        ...
        $expected = <<<'HTML'
            <div x-data='Components.inputAutocomplete({ value: "", filter: "", config: {"value":"id","text":"text","subtext":"subtext","image":"image","limit":999,"min":1}, ajax: [], preload: [], focusLoad: [], conditionals: {"option-focus":"option-focus","option-selected":"option-selected","subtext-focus":"subtext-focus","subtext-selected":"subtext-selected","text-focus":"text-focus","text-selected":"text-selected"}, })' x-cloak x-modelable="value" x-init='init( [{"id":1,"text":"France","subtext":null,"image":null},{"id":2,"text":"Germany","subtext":null,"image":null}], [] )' class="background border color font other padding rounded shadow width float-right">
                <div class="wrapper-background wrapper-border wrapper-color wrapper-font wrapper-other wrapper-padding wrapper-rounded wrapper-shadow wrapper-width" @click.away="close()">
                    <input name="countries_search" type="text" id="countries_search" x-model="filter" @mousedown="open()" @focus="open()" @input.debounce.250="refreshOptions()" @keydown.escape="close()" @keydown.tab="close()" @keydown.enter.stop.prevent="selectOption()" @keydown.arrow-up.prevent="focusPrevOption()" @keydown.arrow-down.prevent="focusNextOption()" autocomplete="off" autocapitalize="off" class="input-background input-border input-color input-font input-other input-padding input-rounded input-shadow" />
                    <svg class="clear-size fill-current clear-background clear-border clear-color clear-other clear-padding clear-rounded clear-shadow" x-show="selected" @click="clear()" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path clip-rule="evenodd" d="M19.5669 5.29918L18.2677 4l-6.7008 6.7008L4.86608 4 3.56689 5.29918 10.2677 12l-6.70081 6.7008L4.86608 20l6.70082-6.7008L18.2677 20l1.2992-1.2992L12.8661 12l6.7008-6.70082z"/>
