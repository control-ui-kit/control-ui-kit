...
class DateRangeTest extends ComponentTestCase
{
    public function setUp(): void
    {
        ...
        Config::set('themes.default.input-date-range.lang', 'en-GB');
