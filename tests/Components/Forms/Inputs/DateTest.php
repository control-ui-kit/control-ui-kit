...
class DateTest extends ComponentTestCase
{
    ...
    public function an_input_date_component_can_be_rendered_with_passed_in_date(): void
    {
        ...
        $expected = <<<'HTML'
            <div class="wrapper-background wrapper-border wrapper-color wrapper-font wrapper-other wrapper-padding wrapper-rounded wrapper-shadow width" x-data="Components.flatpickr({ mode: 'single', data: '2039-08-21' , dataFormat: 'Y-m-d', format: 'd/m/Y', today: 'Today', close: 'Close', locale: 'default', weekNumbers: false, noCalendar: false, enableTime: false, enableSeconds: false, time_24hr: true, hourIncrement: 1, minuteIncrement: 1, minDate: null, maxDate: null, linkedTo: '', linkedFrom: '', separator: '#', })" x-modelable="data" wire:ignore
            >
                <input name="date_display" x-ref="display" type="text" id="date_display" placeholder="DD/MM/YYYY" class="background border color font other padding rounded shadow w-full" autocomplete="off" x-on:blur="updateData()" />
                <input name="date" x-ref="data" x-model="data" type="hidden" id="date" />
            </div>
    ...
    public function an_input_date_component_will_rendered_with_week_numbers(): void
    {
        ...
        $expected = <<<'HTML'
            <div class="wrapper-background wrapper-border wrapper-color wrapper-font wrapper-other wrapper-padding wrapper-rounded wrapper-shadow width" x-data="Components.flatpickr({ mode: 'single', data: '' , dataFormat: 'Y-m-d', format: 'd/m/Y', today: 'Today', close: 'Close', locale: 'default', weekNumbers: true, noCalendar: false, enableTime: false, enableSeconds: false, time_24hr: true, hourIncrement: 1, minuteIncrement: 1, minDate: null, maxDate: null, linkedTo: '', linkedFrom: '', separator: '#', })" x-modelable="data" wire:ignore
            >
                <input name="date_display" x-ref="display" type="text" id="date_display" placeholder="DD/MM/YYYY" class="background border color font other padding rounded shadow w-full" autocomplete="off" x-on:blur="updateData()" />
                <input name="date" x-ref="data" x-model="data" type="hidden" id="date" />
            </div>
    ...
    public function an_input_date_component_will_render_with_min_and_max_dates_added(): void
    {
        ...
        $expected = <<<'HTML'
            <div class="wrapper-background wrapper-border wrapper-color wrapper-font wrapper-other wrapper-padding wrapper-rounded wrapper-shadow width" x-data="Components.flatpickr({ mode: 'single', data: '2020-01-01' , dataFormat: 'Y-m-d', format: 'd/m/Y', today: 'Today', close: 'Close', locale: 'default', weekNumbers: false, noCalendar: false, enableTime: false, enableSeconds: false, time_24hr: true, hourIncrement: 1, minuteIncrement: 1, minDate: '01/01/2019', maxDate: '01/01/2021', linkedTo: '', linkedFrom: '', separator: '#', })" x-modelable="data" wire:ignore
            >
                <input name="date_display" x-ref="display" type="text" id="date_display" placeholder="DD/MM/YYYY" class="background border color font other padding rounded shadow w-full" autocomplete="off" x-on:blur="updateData()" />
                <input name="date" x-ref="data" x-model="data" type="hidden" id="date" />
            </div>
    ...
    public function an_input_date_component_will_render_with_language_changed(): void
    {
        ...
        $expected = <<<'HTML'
            <div class="wrapper-background wrapper-border wrapper-color wrapper-font wrapper-other wrapper-padding wrapper-rounded wrapper-shadow width" x-data="Components.flatpickr({ mode: 'single', data: '2020-01-01' , dataFormat: 'Y-m-d', format: 'd/m/Y', today: 'Today', close: 'Close', locale: 'fr', weekNumbers: false, noCalendar: false, enableTime: false, enableSeconds: false, time_24hr: true, hourIncrement: 1, minuteIncrement: 1, minDate: null, maxDate: null, linkedTo: '', linkedFrom: '', separator: '#', })" x-modelable="data" wire:ignore
            >
    ...
    public function an_input_date_component_will_render_with_a_different_display_format(): void
    {
        ...
        $expected = <<<'HTML'
            <div class="wrapper-background wrapper-border wrapper-color wrapper-font wrapper-other wrapper-padding wrapper-rounded wrapper-shadow width" x-data="Components.flatpickr({ mode: 'single', data: '2020-12-23' , dataFormat: 'Y-m-d', format: 'Y-m-d', today: 'Today', close: 'Close', locale: 'default', weekNumbers: false, noCalendar: false, enableTime: false, enableSeconds: false, time_24hr: true, hourIncrement: 1, minuteIncrement: 1, minDate: null, maxDate: null, linkedTo: '', linkedFrom: '', separator: '#', })" x-modelable="data" wire:ignore
            >
    ...
    public function an_input_date_component_will_render_with_different_data_format(): void
    {
        ...
        $expected = <<<'HTML'
            <div class="wrapper-background wrapper-border wrapper-color wrapper-font wrapper-other wrapper-padding wrapper-rounded wrapper-shadow width" x-data="Components.flatpickr({ mode: 'single', data: '23/12/2020' , dataFormat: 'd/m/Y', format: 'Y-m-d', today: 'Today', close: 'Close', locale: 'default', weekNumbers: false, noCalendar: false, enableTime: false, enableSeconds: false, time_24hr: true, hourIncrement: 1, minuteIncrement: 1, minDate: null, maxDate: null, linkedTo: '', linkedFrom: '', separator: '#', })" x-modelable="data" wire:ignore
            >
                <input name="date_display" x-ref="display" type="text" id="date_display" placeholder="YYYY-MM-DD" class="background border color font other padding rounded shadow w-full" autocomplete="off" x-on:blur="updateData()" />
                <input name="date" x-ref="data" x-model="data" type="hidden" id="date" />
            </div>
    ...
    public function an_input_date_component_can_be_rendered_with_time(): void
    {
        ...
        $expected = <<<'HTML'
            <div class="wrapper-background wrapper-border wrapper-color wrapper-font wrapper-other wrapper-padding wrapper-rounded wrapper-shadow width" x-data="Components.flatpickr({ mode: 'single', data: '' , dataFormat: 'Y-m-d', format: 'd/m/Y', today: 'Today', close: 'Close', locale: 'default', weekNumbers: false, noCalendar: false, enableTime: true, enableSeconds: false, time_24hr: true, hourIncrement: 1, minuteIncrement: 1, minDate: null, maxDate: null, linkedTo: '', linkedFrom: '', separator: '#', })" x-modelable="data" wire:ignore
            >
                <input name="date_display" x-ref="display" type="text" id="date_display" placeholder="DD/MM/YYYY" class="background border color font other padding rounded shadow w-full" autocomplete="off" x-on:blur="updateData()" />
                <input name="date" x-ref="data" x-model="data" type="hidden" id="date" />
            </div>
    ...
    public function an_input_date_component_can_be_rendered_with_only_time(): void
    {
        ...
        $expected = <<<'HTML'
            <div class="wrapper-background wrapper-border wrapper-color wrapper-font wrapper-other wrapper-padding wrapper-rounded wrapper-shadow width" x-data="Components.flatpickr({ mode: 'single', data: '' , dataFormat: 'Y-m-d', format: 'd/m/Y', today: 'Today', close: 'Close', locale: 'default', weekNumbers: false, noCalendar: true, enableTime: true, enableSeconds: false, time_24hr: true, hourIncrement: 1, minuteIncrement: 1, minDate: null, maxDate: null, linkedTo: '', linkedFrom: '', separator: '#', })" x-modelable="data" wire:ignore
            >
                <input name="date_display" x-ref="display" type="text" id="date_display" placeholder="DD/MM/YYYY" class="background border color font other padding rounded shadow w-full" autocomplete="off" x-on:blur="updateData()" />
                <input name="date" x-ref="data" x-model="data" type="hidden" id="date" />
            </div>
    ...
    public function an_input_date_component_can_be_rendered_with_time_including_seconds(): void
    {
        ...
        $expected = <<<'HTML'
            <div class="wrapper-background wrapper-border wrapper-color wrapper-font wrapper-other wrapper-padding wrapper-rounded wrapper-shadow width" x-data="Components.flatpickr({ mode: 'single', data: '' , dataFormat: 'Y-m-d', format: 'd/m/Y', today: 'Today', close: 'Close', locale: 'default', weekNumbers: false, noCalendar: false, enableTime: true, enableSeconds: true, time_24hr: true, hourIncrement: 1, minuteIncrement: 1, minDate: null, maxDate: null, linkedTo: '', linkedFrom: '', separator: '#', })" x-modelable="data" wire:ignore
            >
                <input name="date_display" x-ref="display" type="text" id="date_display" placeholder="DD/MM/YYYY" class="background border color font other padding rounded shadow w-full" autocomplete="off" x-on:blur="updateData()" />
                <input name="date" x-ref="data" x-model="data" type="hidden" id="date" />
            </div>
    ...
    public function an_input_date_component_can_be_rendered_with_time_and_12_hour_clock(): void
    {
        ...
        $expected = <<<'HTML'
            <div class="wrapper-background wrapper-border wrapper-color wrapper-font wrapper-other wrapper-padding wrapper-rounded wrapper-shadow width" x-data="Components.flatpickr({ mode: 'single', data: '' , dataFormat: 'Y-m-d', format: 'd/m/Y', today: 'Today', close: 'Close', locale: 'default', weekNumbers: false, noCalendar: false, enableTime: true, enableSeconds: false, time_24hr: false, hourIncrement: 1, minuteIncrement: 1, minDate: null, maxDate: null, linkedTo: '', linkedFrom: '', separator: '#', })" x-modelable="data" wire:ignore
            >
                <input name="date_display" x-ref="display" type="text" id="date_display" placeholder="DD/MM/YYYY" class="background border color font other padding rounded shadow w-full" autocomplete="off" x-on:blur="updateData()" />
                <input name="date" x-ref="data" x-model="data" type="hidden" id="date" />
            </div>
    ...
    public function an_input_date_component_can_be_rendered_with_time_and_step_increments(): void
    {
        ...
        $expected = <<<'HTML'
            <div class="wrapper-background wrapper-border wrapper-color wrapper-font wrapper-other wrapper-padding wrapper-rounded wrapper-shadow width" x-data="Components.flatpickr({ mode: 'single', data: '' , dataFormat: 'Y-m-d', format: 'd/m/Y', today: 'Today', close: 'Close', locale: 'default', weekNumbers: false, noCalendar: false, enableTime: true, enableSeconds: false, time_24hr: true, hourIncrement: 6, minuteIncrement: 15, minDate: null, maxDate: null, linkedTo: '', linkedFrom: '', separator: '#', })" x-modelable="data" wire:ignore
            >
                <input name="date_display" x-ref="display" type="text" id="date_display" placeholder="DD/MM/YYYY" class="background border color font other padding rounded shadow w-full" autocomplete="off" x-on:blur="updateData()" />
                <input name="date" x-ref="data" x-model="data" type="hidden" id="date" />
            </div>
    ...
    public function an_input_date_component_can_be_rendered_with_linked_to_input(): void
    {
        ...
        $expected = <<<'HTML'
            <div class="wrapper-background wrapper-border wrapper-color wrapper-font wrapper-other wrapper-padding wrapper-rounded wrapper-shadow width" x-data="Components.flatpickr({ mode: 'single', data: '' , dataFormat: 'Y-m-d', format: 'd/m/Y', today: 'Today', close: 'Close', locale: 'default', weekNumbers: false, noCalendar: false, enableTime: false, enableSeconds: false, time_24hr: true, hourIncrement: 1, minuteIncrement: 1, minDate: null, maxDate: null, linkedTo: 'date_to', linkedFrom: '', separator: '#', })" x-modelable="data" wire:ignore
            >
    ...
    public function an_input_date_component_can_be_rendered_with_linked_from_input(): void
    {
        ...
        $expected = <<<'HTML'
            <div class="wrapper-background wrapper-border wrapper-color wrapper-font wrapper-other wrapper-padding wrapper-rounded wrapper-shadow width" x-data="Components.flatpickr({ mode: 'single', data: '' , dataFormat: 'Y-m-d', format: 'd/m/Y', today: 'Today', close: 'Close', locale: 'default', weekNumbers: false, noCalendar: false, enableTime: false, enableSeconds: false, time_24hr: true, hourIncrement: 1, minuteIncrement: 1, minDate: null, maxDate: null, linkedTo: '', linkedFrom: 'date_to', separator: '#', })" x-modelable="data" wire:ignore
            >
    ...
    public function an_input_date_component_can_be_rendered_with_time_showing_based_on_format(): void
    {
        ...
        $expected = <<<'HTML'
            <div class="wrapper-background wrapper-border wrapper-color wrapper-font wrapper-other wrapper-padding wrapper-rounded wrapper-shadow width" x-data="Components.flatpickr({ mode: 'single', data: '' , dataFormat: 'Y-m-d', format: 'm/d/Y h:i:S K', today: 'Today', close: 'Close', locale: 'default', weekNumbers: false, noCalendar: false, enableTime: true, enableSeconds: true, time_24hr: false, hourIncrement: 1, minuteIncrement: 1, minDate: null, maxDate: null, linkedTo: '', linkedFrom: '', separator: '#', })" x-modelable="data" wire:ignore
            >
