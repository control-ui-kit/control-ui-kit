        ...
        $expected = <<<'HTML'
            ...
            >
                <div class="flex space-x-2 items-center m-4">
                    <input name="name_toggle" type="checkbox" id="name_toggle" value="1" class="bg-input focus:ring-brand border-input focus:ring-offset-input text-brand h-4 w-4 cursor-pointer rounded-sm" x-model="fields.name.toggle" x-on:click="toggle()" />
