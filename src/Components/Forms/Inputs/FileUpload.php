...
class FileUpload extends Input
{
    ...
    protected string $component = 'input-file-upload';
    ...
    public function __construct(
        ...
        $this->accept = $this->style('input-file-upload', 'accept', $accept) ?: null;
        $this->multiple = $multiple;
        $this->capture = $this->style('input-file-upload', 'capture', $capture) ?: null;
    }

    public function render(): View
    {
        return view('control-ui-kit::control-ui-kit.forms.inputs.file-upload');
    }
}
