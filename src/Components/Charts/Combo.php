...
class Combo extends Component
{
    ...
    public bool $showSecondAxis;
    public ?string $y1AxisLabel;
    ...
    public function __construct(
        ...
        $this->showSecondAxis = ($showSecondAxis ?? 'false') !== 'false';
    ...
    {
        return view('control-ui-kit::control-ui-kit.charts.combo-chart', [
    ...
    private function chartOptions(): array
    {
        ...
        if ($this->showSecondAxis) {
            $scales['y1'] = [
                'type' => 'linear',
                'display' => true,
                'position' => 'right',
                'title' => [
                    'display' => ! empty($this->y1AxisLabel),
