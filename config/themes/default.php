...
//        'active-filter-width' => '',
        ...
        'active-filters-wrapper-padding' => 'mt-2 sm:mt-4',
...
//        'more-button-border' => 'focus:outline-none focus:ring-0 border-0 border-transparent focus:border-1 focus:border-brand',
        ...
        'search-wrapper-font' => '',
        'search-wrapper-other' => 'flex items-center',
        ...
        'table-filters-color' => '',
        'table-filters-container' => 'flex-grow w-auto flex flex-col items-end',
        'table-filters-font' => '',
        ...
        'table-wrapper-without-filters' => 'mt-2 sm:mt-4',
    ...
    'table-filter' => [
        ...
        // Style
        'button-background' => '',
        'button-border' => 'focus:outline-none focus:ring-0 w-full border border-transparent focus:border-brand',
        'button-color' => '',
        'button-font' => 'text-input',
