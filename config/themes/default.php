...
return [
    ...
    'input-autocomplete' => [
        ...
        'dropdown-color' => '',
        'dropdown-other' => 'absolute  top-10 left-0 overflow-auto z-50',
        'dropdown-padding' => 'mt-1',
        'dropdown-rounded' => 'rounded',
        'dropdown-shadow' => '',
        'dropdown-width' => 'max-h-64 min-w-[12rem] w-max',
        ...
        'subtext-focus' => '',
        'subtext-font' => '',
        'subtext-other' => 'text-xs truncate w-full normal-case font-normal -mt-1 text-gray-500',
        'subtext-padding' => '',
        'subtext-rounded' => '',
        'subtext-selected' => '',
        'subtext-shadow' => '',
