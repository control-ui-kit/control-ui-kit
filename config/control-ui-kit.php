...
return [
    ...
    */
    ...
    'icons' => [
        ...
        'icon-facebook' => \ControlUIKit\Components\Icons\Facebook::class,
        ...
        'icon-instagram' => \ControlUIKit\Components\Icons\Instagram::class,
        ...
        'icon-soundcloud' => \ControlUIKit\Components\Icons\Soundcloud::class,
        ...
        'icon-thumbs-down' => \ControlUIKit\Components\Icons\ThumbsDown::class,
        'icon-thumbs-up' => \ControlUIKit\Components\Icons\ThumbsUp::class,
        ...
        'icon-tumblr' => \ControlUIKit\Components\Icons\Tumblr::class,
        'icon-twitter' => \ControlUIKit\Components\Icons\Twitter::class,
        ...
        'icon-youtube' => \ControlUIKit\Components\Icons\Youtube::class,
