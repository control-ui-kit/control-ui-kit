...
return [
    ...
    */
    ...
    'components' => [
        ...
        'button-group' => \ControlUIKit\Components\Buttons\ButtonGroup::class,
        'button-group-item' => \ControlUIKit\Components\Buttons\ButtonGroupItem::class,
        ...
        'field-file-upload' => \ControlUIKit\Components\Forms\Fields\FileUploadField::class,
        'field-image-upload' => \ControlUIKit\Components\Forms\Fields\ImageUploadField::class,
        ...
        'field-link' => \ControlUIKit\Components\Forms\Fields\LinkField::class,
        ...
        'field-tags' => \ControlUIKit\Components\Forms\Fields\TagsField::class,
        ...
        'input-link' => \ControlUIKit\Components\Forms\Inputs\Link::class,
        ...
        'input-file-upload' => \ControlUIKit\Components\Forms\Inputs\FileUpload::class,
        'input-image-upload' => \ControlUIKit\Components\Forms\Inputs\ImageUpload::class,
        ...
        'input-tags' => \ControlUIKit\Components\Forms\Inputs\Tags::class,
    ...
    */
    ...
    'icons' => [
        ...
        'icon-audio-stream' => \ControlUIKit\Components\Icons\AudioStream::class,
        ...
        'icon-release-download' => \ControlUIKit\Components\Icons\ReleaseDownload::class,
        ...
        'icon-track-download' => \ControlUIKit\Components\Icons\TrackDownload::class,
        ...
        'icon-upload' => \ControlUIKit\Components\Icons\Upload::class,
        ...
        'icon-video-stream' => \ControlUIKit\Components\Icons\VideoStream::class,
