...
return [
    ...
    */
    ...
    'components' => [
        ...
        'field-color-picker' => \ControlUIKit\Components\Forms\Fields\ColorPicker::class,
        'field-currency' => \ControlUIKit\Components\Forms\Fields\Currency::class,
        'field-decimal' => \ControlUIKit\Components\Forms\Fields\Decimal::class,
        ...
        'field-email' => \ControlUIKit\Components\Forms\Fields\Email::class,
        'field-info' => \ControlUIKit\Components\Forms\Fields\Info::class,
        'field-input' => \ControlUIKit\Components\Forms\Fields\Input::class,
        'field-number' => \ControlUIKit\Components\Forms\Fields\Number::class,
        'field-password' => \ControlUIKit\Components\Forms\Fields\Password::class,
        'field-percent' => \ControlUIKit\Components\Forms\Fields\Percent::class,
        'field-radio-group' => \ControlUIKit\Components\Forms\Fields\RadioGroup::class,
        'field-range' => \ControlUIKit\Components\Forms\Fields\Range::class,
        'field-royalty' => \ControlUIKit\Components\Forms\Fields\Royalty::class,
        ...
        'field-toggle' => \ControlUIKit\Components\Forms\Fields\Toggle::class,
        'field-textarea' => \ControlUIKit\Components\Forms\Fields\Textarea::class,
        'field-url' => \ControlUIKit\Components\Forms\Fields\Url::class,
